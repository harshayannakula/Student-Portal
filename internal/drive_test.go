...
func TestEligibility_checkEligibility(t *testing.T) {
	...
	t.Run("should handle zero requirement", func(t *testing.T) {
		...
		if el.checkEligibility(a) {
			t.Error("Zero requirement should fail for any positive CGPA")
		}
	})
